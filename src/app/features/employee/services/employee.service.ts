...
import { EmployeeResponse, SingleEmployeeResponse, EmployeeFormData } from '../models/employee.model';
...
export class EmployeeService {
  ...
  createEmployee(employee: EmployeeFormData): Observable<SingleEmployeeResponse> {
